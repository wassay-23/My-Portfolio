    ...
    const links = [
        {
            ...
            href: 'https://www.linkedin.com/in/abdul-wassay23/',
            style: 'rounded-tr-md'
        },
        {
            id: 2,
            ...
            href: 'https://github.com/wassay-23'
        },
        {
            id: 3,
            child: (
            ...
            href: 'mailto:abdulwassay2003@gmail.com'
        },
        {
            id: 4,
            child: (
            ...
            href: 'https://drive.google.com/file/d/1ZDckZSfIsNoc6imAght5-GawYV79iMwX/view?usp=drive_link',
            style: 'rounded-br-md',
            download: true
        }
    ]
